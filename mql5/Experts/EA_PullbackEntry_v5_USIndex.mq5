...
long GenerateMagicNumber_PBEv5()
{
   ...
   return (long)(55100000 + (h % 9000000));
}
...
int OnInit()
{
   ...
   string instanceId = "EA_PullbackEntry_v5_USIndex|" + _Symbol + "|Acct:" + AccountModeTag() + "|Magic:" + (string)g_EffectiveMagicNumber + "|CID:" + (string)ChartID();
   ...
   {
      ApplyPresetAll(cfg, filterCfg, posCfg, InpPreset, g_dollarMultiplier);
