...
input string InpTerminalId = "10900k-mt5-fx";                 // 端末固定ID（例: 10900k-mt5-fx / 10900k-mt5-index）。live/demoは含めない
...
int OnInit()
{
   ...
   string instanceId = "EA_PullbackEntry_v5_FX|" + _Symbol + "|Acct:" + AccountModeTag() + "|Magic:" + (string)g_EffectiveMagicNumber + "|CID:" + (string)ChartID();
   ...
   {
      ApplyPresetAll(cfg, filterCfg, posCfg, InpPreset, g_pipMultiplier);
